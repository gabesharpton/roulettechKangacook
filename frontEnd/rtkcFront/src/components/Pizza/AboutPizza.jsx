...
const AboutPizza = () => {
    return (
        <div>
            ...
            <p>
                Pizza is loved by people all around the world and comes in many different styles and flavors. Whether you prefer a classic Margherita pizza or a loaded meat lover's pizza, there's something for everyone to enjoy.
            </p>
        </div>
    );
};
